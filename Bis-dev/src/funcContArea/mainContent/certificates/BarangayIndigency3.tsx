    ...
    <>
      <div className="clearanceMain">
        ...
        <p className="regular">
          ...
          is a bonafide resident of Barangay, Butnga, Oras, Eastern Samar.
          <br></br>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; This
            Further certifies that the above-named person is a law-abiding
            citizen and not suspected to be a member of any subversive
            organization.
          </p>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; THIS
...
export default BarangayIndigency3;
