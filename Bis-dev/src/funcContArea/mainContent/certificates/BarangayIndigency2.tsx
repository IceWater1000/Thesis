  ...
  return (
    <>
      <div className="clearanceMain">
        ...
        <p className="h2">
          <strong>CERTIFICATE OF PERSON IN CRISIS SITUATION</strong>
        </p>
        ...
        <p className="regular">
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;This
            Further certifies that their family are having family difficulty and
            with no sufficient source of income to finance the needs of her
            family.
          </p>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; THIS
...
export default BarangayIndigency2;
