...
import BarangayBusinessClearance from "./certificates/BarangayBusinessClearance";
...
const MainContentAreaCertificates5 = () => {
  // the Select Option
...
export default MainContentAreaCertificates5;
